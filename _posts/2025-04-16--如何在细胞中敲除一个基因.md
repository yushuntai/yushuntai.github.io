...
CRISPR会对目标DNA双链切割，而DSB会激活细胞自身的DSB修复机制，该修复机制会引入突变，如：indel、倒位、拷贝数变异等。这些突变会导致癌症发生
...
哈佛大学的David Liu（刘如谦）在CRISPR的基础上开发了对活的生物体做精准基因编辑的方法Prime Editing。该技术通过巧妙融合 Cas9 - nickase 与逆转录酶，成功解锁了任意类型编辑的可能性，极大地拓展了基因编辑的边界，为攻克诸多复杂基因编辑难题提供了新的解决方案。
