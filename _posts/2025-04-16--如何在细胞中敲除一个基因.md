...
满足U6启动子最优转录起始的要求，CACC后面第一个应该为G，若设计的sgRNA上不含G，则人为添加一个。
...
（2）设计正反向引物，将这两条Oligo退火：10μL sgRNA-F和10μL sgRNA-R混合均匀，95℃ 10min，90℃ 3min，85℃ 3min，80℃ 3min ……（以每5℃为一个梯度进行），25℃ 3min。即得退火片段。<br>
