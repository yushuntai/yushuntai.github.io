...
*文字斜体*                 <br>
<mark>文字高亮</mark>      <br>
<span style="color: red;">**文字变色**</span>                                <br>
- **文字实心圈**:                  <br>
  - 文字空心圈                      <br>

<del>文字删除</del>                <br>
文字缩写，如 <abbr title="HyperText Markup Langage">HTML</abbr>              <br>
文字 <sup>上标</sup>                <br>
文字 <sub>下标</sub>                <br>

[文字链接](https://developer.mozilla.org/en-US/docs/Web/HTML/Element).
...
*文字斜体*                
<mark>文字高亮</mark>      
<span style="color: red;">**文字变色**</span>                               
- **文字实心圈**:                 
  - 文字空心圈                     
 <del>文字删除</del>               
文字缩写，如 <abbr title="HyperText Markup Langage">HTML</abbr>             
文字 <sup>上标</sup>               
文字 <sub>下标</sub>
[文字链接](https://developer.mozilla.org/en-US/docs/Web/HTML/Element).         
```
...
<img src="/assets/images/Figure38.png" width="888">
...
<table>
  ...
  <tr>
    ...
    <td>辰</td>
    <td>巳</td>
    <!-- 第五列已被上一行的 rowspan 占用，此处无需再写单元格 -->
  </tr>
</table>
...
<img src="/assets/images/Figure39.png" width="888">


```
<table>
  <tr>
    <td colspan="2" style="text-align: center; vertical-align: middle;">甲</td>
    <td>乙</td>
    <td>丙</td>
    <td>丁</td>
  </tr>
...
## 如何一次性下载本网站所有的markdown文件

<img src="/assets/images/Figure1.png" width="600">
...
```
https://github.com/yushuntai/yushuntai.github.io/assets/61654690/xxxx
```
这是 GitHub 自动生成的「仓库附件资产（assets）」链接，一旦你删库、重建库、或清空历史 👉 链接就会 永久失效。所以不能直接将图片粘贴进来，虽然直接粘贴进来也能显示，但是这个操作很危险。所以要将图片直接放在 GitHub 仓库中，

### 建立GitHub 仓库（建立一次即可永久使用）
...
回到仓库主页——点击 assets 文件夹——点击 images 文件夹——点击 Add file —— Upload files——把图片直接拖进来——点击commit changes。


```
![Figure 1](/assets/images/Figure2.png)   # Markdown 写法（推荐）
<img src="/assets/images/Figure2.png" width="600">   # HTML 写法
```

操作步骤如下图所示

![Figure 1](/assets/images/Figure2.png) 


## 如何修改个人介绍部分

<img src="/assets/images/Figure3.png" width="600">

## 如何修改网站封面部分

![Figure 1](/assets/images/Figure5.png) 
